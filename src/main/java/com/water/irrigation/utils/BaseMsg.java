...
public class BaseMsg<T> implements Serializable{
    ...
    private final static String ERROR_INFO = "error";
    ...
    public static BaseMsg error(Serializable data) {
        return new BaseMsg(BaseMsg.FAILURE_CODE, BaseMsg.ERROR_INFO, data);
    }
